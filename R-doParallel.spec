...
Version  : 1.0.17
Release  : 52
URL      : https://cran.r-project.org/src/contrib/doParallel_1.0.17.tar.gz
Source0  : https://cran.r-project.org/src/contrib/doParallel_1.0.17.tar.gz
...
export LANG=C.UTF-8
export SOURCE_DATE_EPOCH=1644251849
